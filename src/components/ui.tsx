...
export function SqlCode({ children }: { children: string }) {
  return (
    <pre className="max-w-full overflow-x-auto whitespace-pre rounded-md border border-slate-800 bg-slate-950 p-4 text-left text-sm leading-6 text-slate-100">
      <code>{children}</code>
    </pre>
  )
}
